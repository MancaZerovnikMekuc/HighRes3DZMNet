...
class ModelSaver(object):
    ...
    def save_model_interval(self, _sender, **msg):
        ...
        #        self._save_at(iter_i)
        #else:
        #    if not msg['iter_msg'].is_validation:
        #        return
        #    loss1 = msg['iter_msg'].current_iter_output['niftynetconsole']['loss']
        #    loss2 = msg['iter_msg'].current_iter_output['niftynetconsole']['loss_1']
        #    print(BEST_LOSS)
        #    iter_i = msg['iter_msg'].current_iter
        #    if BEST_LOSS > (loss1+loss2)/2:
        #        #BEST_LOSS = (loss1+loss2)/2
        #        self._save_at(iter_i)
