...
SUPPORTED_NETWORK = {
    ...
    "highres3dnet_norm":
        'niftynet.network.highres3dnet_norm.HighRes3DNetNorm',
    "highres3dnet_small":
    ...
    "vnet_bn": 'niftynet.network.vnet_bn.VNetBn',
}
...
SUPPORTED_LOSS_SEGMENTATION = {
    ...
    "DiceClassTwo":
        'niftynet.layer.loss_segmentation.dice_class_two',
    "DiceClassOne":
        'niftynet.layer.loss_segmentation.dice_class_one'
    # "L1Loss":
